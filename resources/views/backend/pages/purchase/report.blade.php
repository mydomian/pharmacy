                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title m-0">Purchase Report</h4>
                            <a href="{{ route('purchases.create') }}" class="btn btn-sm btn-success waves-effect waves-light">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Table -->
                            @php $grandTotal = $purchases->sum('total_amount'); @endphp
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center align-items-center gap-2">
                                                <a href="{{ route('purchases.print', $purchase->id) }}" class="btn btn-sm btn-light d-flex justify-content-center align-items-center gap-1">
                                                    <i class="fas fa-print"></i> Print
                                                </a>
                                                <a href="{{ route('purchases.show', $purchase->id) }}" class="btn btn-sm btn-info d-flex justify-content-center align-items-center gap-1">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                <a href="{{ route('purchases.edit', $purchase->id) }}" class="btn btn-sm btn-primary d-flex justify-content-center align-items-center gap-1">
