                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h4 class="card-title m-0">Supplier Create</h4>
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('suppliers.store') }}" method="POST">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="address" name="address" placeholder="Enter address" title="Enter address here">
                                                </div>
